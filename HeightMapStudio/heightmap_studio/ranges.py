...
GROUPS = (
    ...
    ("Displacement", (("disp_contrast", "Contrast", 0, 4, 1000000), ("disp_level", "Level", -1, 1, 1000000))),
    ("AO", (("ao_strength", "Strength", 0, 10, 1000000), ("ao_radius", "Radius", 1, 128, 128))),
    ("Specular", (("spec_brightness", "Brightness", -1, 1, 1000000), ("spec_contrast", "Contrast", 0, 4, 1000000))))
